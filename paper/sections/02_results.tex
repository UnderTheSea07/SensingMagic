...
specimens gives moduli of $0.72\pm0.11$ (non-magnetic), $0.85\pm0.09$ ($x$),
$0.73\pm0.11$ ($y$) and $0.68\pm0.11$~MPa ($z$-magnetized)
(mean\,$\pm$\,s.d., $n=$~\dataneeded{specimens per group}), indicating that
magnetization direction does not substantially alter stiffness;
