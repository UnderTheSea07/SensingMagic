...
normal loading, with sensitivities spanning approximately 3--50~mT\,N$^{-1}$
and long, slender cilia ($L=8$~mm) giving the largest response; large-depth
points fall systematically below the small-signal trend, consistent with
deflection saturation (Fig.~2e). Repeated manual loading on a fixed patch gave
