...
characterization.}
\textbf{(a)} NdFeB--PDMS composition (2000-mesh powder, 10:1 base:curing),
particle distribution and magnetization direction, with sample photograph.
\textbf{(b)} Fabrication: mixing, degassing, mould filling, curing,
demoulding + single-step magnetization.
