...
characterization.}
\textbf{(a)} NdFeB--elastomer composition (2000-mesh powder; Ecoflex for skin
patches, PDMS 10:1 for geometry samples), particle distribution,
pre-alignment and final magnetization directions, with sample photograph.
\textbf{(b)} Fabrication workflow: mixing, vacuum degassing (15~min),
pre-cure (5~min), mould filling, magnetic pre-alignment, full cure (60~min),
demoulding + saturation magnetization.
...
stress--strain to failure; tensile moduli $0.72\pm0.11$ / $0.85\pm0.09$ /
$0.73\pm0.11$ / $0.68\pm0.11$~MPa (non-mag / $x$ / $y$ / $z$),
$n=$~\dataneeded{specimens per group}, hysteresis \dataneeded{\%}. \textbf{(e)} Geometry--sensitivity response surface over the nine $(L,d)$
